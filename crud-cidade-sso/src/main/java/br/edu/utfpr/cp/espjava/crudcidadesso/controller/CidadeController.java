package br.edu.utfpr.cp.espjava.crudcidadesso.controller;

import br.edu.utfpr.cp.espjava.crudcidadesso.dto.CidadeDTO;
import br.edu.utfpr.cp.espjava.crudcidadesso.service.CidadeService;
...
public class CidadeController {
    ...
    public String alterar(@RequestParam String nomeAtual, @RequestParam String estadoAtual, CidadeDTO cidade, BindingResult bindingResult, Model model, HttpServletResponse response) {
        ...
        if (cidadeAtual != null) {
            ...
            cidadeService.salvarCidade(cidadeAtual);
        }
